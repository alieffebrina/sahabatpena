...
<input id="kategori_barang" class="form-control" value="bahan" readonly>
</td></tr>
...
<tr><td>Harga Jual</td><td>:</td><td><input class="form-control" id="harga_jual" onkeyup="reformatText(this)" value="0" readonly>	</td></tr>
