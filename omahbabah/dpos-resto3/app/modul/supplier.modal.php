...
<h4 class="modal-title" id="EditPostLabel"><i class="fa fa-check-square-o" aria-hidden="true"></i>  Data Supplier</h4>
<span style="display:none"><input  class="form-control" type="text" id="id"></span>
<table class="table">
<tr><td style="width:150px">Nama Supplier</td><td>:</td><td><input class="form-control" id="nama_supplier">	</td></tr>
...
<tr><td>Website</td><td>:</td><td><input class="form-control" id="website">	</td></tr>
...
<h5 class="modal-title" id="EditPostLabel">Import Data Supplier</h5>
</div>
<div class="modal-body">
<div class="well">
<form id="uploadForm" action="" method="post">
<input name="fileExcel" type="file" class="inputFile" id="fileExcel"/>
<input name="fileTable" type="text" id="fileTable" value="supplier" style="display:none"/>
<input type="submit" value="Upload Excel " class="btn btn-primary btn-sm" style="margin-top:3px"/>
<div id="data"></div>
</form>
</div>
<a href="files/template_supplier.xls" class="btn btn-success"><i class="fa fa-file-excel-o"></i> template_supplier.xls</a>
<br/>
<h4>Panduan import data dari Excel :</h4>
<ol>
<li>Download file excel <b>template_supplier.xls</b> kemudian edit sesuai data Anda</li>
