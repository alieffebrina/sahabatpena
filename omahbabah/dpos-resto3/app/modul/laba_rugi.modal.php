...
<tr ><td>Pemasukan</td><td> : </td><td><input id="pemasukan" name="pemasukan" placeholder="" class="form-control" onkeyup="reformatText(this)"></td></tr>
<tr  ><td>Pengeluaran</td><td> : </td><td><input id="pengeluaran" name="pengeluaran"  placeholder="" class="form-control" onkeyup="reformatText(this)"></td></tr>
