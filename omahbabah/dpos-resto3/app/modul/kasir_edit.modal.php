...
<input class="form-control" type="text" id="faktur" readonly value="<?php echo $_GET['faktur'];?>">
</div>
<div class="input-group" style="width:100%;margin-top:5px">
...
<button disabled class="btn btn-default" type="button" id="showPelanggan"><i class='fa fa-search'></i> Cari</button></span>
</div>
</td></tr>
...
<a class="btn btn-primary" href="#" id="printKasir" ><i class="fa fa-print" aria-hidden="true"></i> Cetak Struk</a>
	<a class="btn btn-primary" href="#" id="newKasir"><i class="fa fa-check" aria-hidden="true"></i> Transaksi Baru</a>
	<a class="btn btn-danger" href="#" id="selesai"><i class="fa fa-window-close" aria-hidden="true"></i> Selesai</a>
	</center>
<div style="display:none">
