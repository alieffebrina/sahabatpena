...
$config='config.php';
$myfile=fopen($config,'w') or die('Gagal menemukan file config.php');
$txt='<?php 
/* APLIKASI '.$SNAME.'
 *
 * Framework DPOS-PHP 
...
fclose($myfile);
	...
	<h4><i class="icon fa fa-check"></i> Instalasi Berhasil !</h4><a href="page.php?page=login">Silakan Login</a>	</div>';
}else{
	$alert="";
}
...
<div class="form-group has-feedback">
<input disabled  type="checkbox" value="1" name="setuju" checked> Saya setuju dengan <a target="_BLANK" href="page.php?page=readme">ketentuan dan lisensi</a> yang berlaku     
</div>
<div class="row">
<!-- /.col -->
<div class="col-xs-4">
...
<!-- /.login-box-body -->
	<center><a href="page.php?page=login" class="btn btn-default btn-block btn-flat pull-right" ><i class="fa fa-fw fa-caret-square-o-left  "></i> Login</a>
	<br>
	<br>
