...
class Mailer {
    ...
    // protected $email_pengirim = 'tes.hosterweb@gmail.com'; // Isikan dengan email pengirim
    // protected $nama_pengirim = 'hosterweb'; // Isikan dengan nama pengirim
    // protected $password = 'veryaprzdoexroew'; // Isikan dengan password email pengirim

    protected $email_pengirim = 'sahabatpena@sahabatpenakita.id'; // Isikan dengan email pengirim
    protected $nama_pengirim = 'hosterweb'; // Isikan dengan nama pengirim
    protected $password = 'Pastisukses2020'; // Isikan dengan password email pengirim
    ...
    public function send($data){
        $mail = new PHPMailer;
        $mail->isSMTP();
        $mail->Host = 'mail.sahabatpenakita.id';
        ...
        $mail->isHTML(false); // Aktifkan jika isi emailnya berupa html
        $mail->Subject = $data['subjek'];
        $mail->Body = $data['content'];
        // $mail->AddEmbeddedImage('images/logo.png', 'logo_mynotescode', 'logo.png'); // Aktifkan jika ingin menampilkan gambar dalam email
        $send = $mail->send();
