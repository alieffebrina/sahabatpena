      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <?php echo form_open("C_Informasi/tambah", array('enctype'=>'multipart/form-data', 'class'=>'form-horizontal') ); ?>
            <div class='row'>
                  <div class="col-lg-12">
                    <label for="inputEmail3" class="col-sm-1 control-label">Judul</label>
                      <div class="col-sm-9">
                        <input type="text" class="form-control" id="judul" name="judul" placeholder="Judul Informasi">
