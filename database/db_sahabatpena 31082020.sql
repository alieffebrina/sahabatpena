...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 31, 2020 at 05:12 PM
...
INSERT INTO `tb_anggota` (`id_anggota`, `nik`, `nama`, `alamat`, `id_provinsi`, `id_kota`, `id_kecamatan`, `email`, `tlp`, `id_user`, `tglupdate`, `foto`, `statusanggota`, `tempatlahir`, `tgllahir`, `facebook`, `instagram`, `twitter`, `youtube`, `institusi`, `latarbelakang`, `tglregistrasi`, `domisilianggota`, `username`, `password`, `noanggota`) VALUES
(1, '', 'administrator', '', '', '', '', '', '', 1, '2020-08-24 21:57:03', NULL, 'administrator', '', '0000-00-00', NULL, NULL, NULL, NULL, '', '', '2020-08-24', '', 'admin', 'admin', ''),
(2, '1111111111111111', 'RIZKY FEBRIANTO', 'asd', '12', '1202', '1202054', 'ad@ads', '131123', 1, '2020-08-24 04:59:39', 'happy_ied_mubarak_alief.jpg', 'anggota', 'ad', '2020-07-29', '', '', '', '', 'asd', 'sadasd', '2020-08-24', 'SPK Pusat', 'riski', '1', 'k001'),
(5, '1111111111111114', 'asdm', 'asd', '14', '1403', '1403123', 'ad@ads', '131', 0, '2020-08-31 04:55:57', 'lebaran_via2.jpg', 'anggota', 'asd', '2020-08-12', 'asd', 'asd', 'asd', '', 'asd', 'sadasd', '2020-08-30', 'SPK Cabang', NULL, NULL, 'k003');

-- --------------------------------------------------------

--
-- Table structure for table `tb_detailkorwil`
--

CREATE TABLE `tb_detailkorwil` (
  `id_detailkorwil` int(11) NOT NULL,
  `id_korwil` int(11) NOT NULL,
  `id_anggota` int(11) NOT NULL,
  `jabatan` varchar(100) NOT NULL,
  `sk` varchar(200) NOT NULL,
  `susunanpengurus` varchar(200) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(1, 2, 'fa fa-unlock-alt', 'C_Korwil', 'Data Korwil', 'aktif'),
(2, 1, 'fa fa-users', 'C_User', 'Data Anggota', 'aktif'),
(3, 3, 'fa fa-suitcase', 'C_Muatan', 'Hak Akses', 'aktif'),
(4, 4, 'fa fa-dollar', 'C_Harga', 'Data Pengurus Pusat', 'aktif'),
(5, 5, 'fa fa-files-o', 'C_Transaksi', 'Laporan Anggota', 'aktif'),
(6, 6, 'fa fa-table', 'C_User/laporan', 'Laporan Data Korwil', 'aktif'),
(7, 7, '', '', 'Setting ID Anggota', 'aktif'),
(8, 8, '', 'Informasi', 'Informasi', 'aktif'),
(9, 9, '', '', 'Input Karya Tulis', 'aktif');
...
--
-- Indexes for table `tb_detailkorwil`
--
ALTER TABLE `tb_detailkorwil`
  ADD PRIMARY KEY (`id_detailkorwil`);
...
--
-- AUTO_INCREMENT for table `tb_detailkorwil`
--
ALTER TABLE `tb_detailkorwil`
  MODIFY `id_detailkorwil` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tb_karyatulis`
--
ALTER TABLE `tb_karyatulis`
  MODIFY `id_karyatulis` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `tb_korwil`
--
ALTER TABLE `tb_korwil`
  MODIFY `id_korwil` int(11) NOT NULL AUTO_INCREMENT;
